...
class DateTimeToLocalizedStringTransformerTest extends DateTimeTestCase
{
    ...
    public function testTransformWrapsIntlErrors()
    {
        ...
        //$this->setExpectedException('Symfony\Component\Form\DataTransformer\Transdate_formationFailedException');
    ...
    public function testReverseTransformWrapsIntlErrors()
    {
        ...
        $this->setExpectedException('Symfony\Component\Form\DataTransformer\TransformationFailedException');
